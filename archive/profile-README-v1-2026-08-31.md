> **ARCHIVED 2026-08-31.** Superseded by CR-TNH-README-06 (Organization README) under the
> TechNeHub Labs Portfolio Navigation programme (CR-TNH-README-01 through CR-TNH-README-07).
> The repository inventory table below was retired as the primary navigation mechanism; the
> live inventory is maintained in the [portfolio index](../portfolio/README.md) and the
> [portfolio registry](../registry/repositories.yaml). Content below is verbatim as archived.
...
| [`dea-concepts-model`](https://github.com/technehub-labs/dea-concepts-model) | Core | OpenDEA Concepts Model: canonical conceptual layer between the DEA Metaframework (ECF) and the DEA Metamodel (CR-CM-001). |
| [`dea-ontology`](https://github.com/technehub-labs/dea-ontology) | Core | Enterprise Ontology: canonical grounding repository for formal OWL/RDF ontology practice and authoring of sector-specific Enterprise Ontologies (CR-EO-01). |
| [`dea-semantic-architecture`](https://github.com/technehub-labs/dea-semantic-architecture) | Core | Enterprise Semantic Architecture: canonical grounding repository for how enterprises organise meaning (semantic layers, vocabularies, concept graphs, knowledge-graph architectures) (CR-ESA-01). |
